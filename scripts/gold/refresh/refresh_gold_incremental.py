...
GOLD_FACT_STEP = (
    ...
    "scripts.gold.refresh.refresh_gold_facts_incremental",
    True,
)

GOLD_DIMENSION_STEP = (
    "Refresh Gold dimensions incremental",
    "scripts.gold.refresh.refresh_gold_dimensions_incremental",
    True,
)
...
GOLD_SERVING_STEPS = [
    (
        ...
        "scripts.gold.refresh.refresh_gold_content_quality_hourly_incremental",
        True,
    ),
    (
        "Refresh Gold post performance incremental",
        "scripts.gold.refresh.refresh_gold_post_performance_incremental",
        True,
    ),
    (
        "Refresh Gold thread conversation summary incremental",
        "scripts.gold.refresh.refresh_gold_thread_conversation_summary_incremental",
        True,
    ),
    (
        "Refresh Gold network growth daily incremental",
        "scripts.gold.refresh.refresh_gold_network_growth_daily_incremental",
        True,
    ),
    (
        "Refresh Gold actor activity daily incremental",
        "scripts.gold.refresh.refresh_gold_actor_activity_daily_incremental",
        True,
    ),
]
